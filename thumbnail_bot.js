...
const IMAGE_PREFIX = process.env.IMAGE_PREFIX || 'Live_Thumbnail'; // <-- ADDED THIS
...
async function generateAndUploadThumbnail() {
    ...
    const outputImagePath = `${IMAGE_PREFIX}_${uniqueTime}.png`; // <-- CHANGED THIS
    try {
...
// ======================= 200% yeh codee full teek hai , bas opper waley mei yeh images jo save hoty hai realese mei iska name dynamic karney k liye input create karta hu ====================================
...
// =================== yeh code bilkul teek hai bas try catch wala checks lagaya hai opper waley mei =======================-
